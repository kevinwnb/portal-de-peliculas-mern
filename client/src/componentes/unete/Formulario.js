...
const Formulario = () => {
    ...
    return (<form onSubmit={e => send(e)}>
        <h6 className="display-6 text-center">Únete</h6>

        <div className="fn d-flex flex-column">
            <label htmlFor="fn" className={(validateNombre && "text-danger ")}>Nombre</label>
            <input className={(validateNombre && "border-danger ")} id="fn" onChange={e => setNombre(e.target.value)} type="text" />
        ...
        <div className="ln d-flex flex-column">
            ...
            <input className={(validateApellidos && "border-danger ")} id="ln" onChange={e => setApellidos(e.target.value)} type="text" />
        ...
        <div className="em d-flex flex-column">
            ...
            <input className={(validateEmail && "border-danger ")} id="em" onChange={e => setEmail(e.target.value)} type="text" />
        ...
        <div className="pw d-flex flex-column">
            ...
            <input className={(validatePw && "border-danger ")} id="pw" onChange={e => setPw(e.target.value)} type="text" />
        ...
        <div className="rpw d-flex flex-column">
            ...
            <input className={(validateRpw && "border-danger ")} id="rpw" onChange={e => setRpw(e.target.value)} type="text" />
